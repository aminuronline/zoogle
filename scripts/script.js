function getDescription(animal) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const animals = query
      ? animalsdata && animalsdata.filter((a) => {
          return (
            a.name.toLowerCase().includes(query.toLowerCase()) ||
            a.animal_type.toLowerCase().includes(query.toLowerCase())
          );
        })
      : [];
    ...
    if (animals.length > 0) {
      animals.forEach((a) => {
        ...
        html.innerHTML = `<a href="animal.html?id=${a.id}"><h3>${
          a.name
        }</h3></a>
            <p>
             ${getDescription(a)}
      ...
      let asidehtml = document.createElement("article");
      asidehtml.innerHTML = `
      <img src="${animals[0].image_link}" />
      <section class="spacing">
      <h3>${animals[0].name}</h3>
           
            <p>
              The ${animals[0].name} has the latin name <b>${animals[0].latin_name}</b>
            </p>
            </section>
            `;
